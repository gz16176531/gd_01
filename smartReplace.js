...
async function downloader_jd() {
    ...
    if (remoteContent.indexOf("new Env('京喜农场')") > 0) {
        ...
        await download(
            "https://github.com/gz154838009/jd_01/raw/main/USER_AGENTS.js",
            "./USER_AGENTS.js",
            "USER_AGENTS"
        );
    }
...
async function downloader_user_agents() {
    await download("https://github.com/gz154838009/jd_01/raw/main/USER_AGENTS.js", "./USER_AGENTS.js", "云端UA");
}
